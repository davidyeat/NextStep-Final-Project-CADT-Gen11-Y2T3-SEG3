...
export const getUniversityById = async (req, res) => {
  try {
    const university = await universityRepository.getUniversityById(
      req.params.id,
    );
    if (!university) {
...
export const updateUniversity = async (req, res) => {
  try {
    const updatedUniversity = await universityRepository.updateUniversity(
      req.params.id,
      req.body,
    );
...
// GET /api/universities/search?name=universityName