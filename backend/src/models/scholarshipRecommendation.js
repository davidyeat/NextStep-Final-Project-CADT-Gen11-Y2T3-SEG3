...
const ScholarshipRecommendation = sequelize.define("ScholarshipRecommendation", {
    scholarshipRecommendationId: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
...
}, { timestamps: true, indexes: [{ unique: true, fields: ["recommendationRunId", "scholarshipId"] }] });
